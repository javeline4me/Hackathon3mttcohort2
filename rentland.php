...
<title>Rent land</title>
</head>

<body>
<table  border="1">
<tr><td colspan="15" align="center"> <h3>RENT LAND </h3></td></tr>
...
<tr>
    ...
    <td>PAY NOW</td>
      ...
      $sqlsetup = "SELECT * FROM landregistration WHERE landid='$landid'";
...
$landid =$raw["landid"];
    ...
    <td>
<a href="paylease.php?id=<?php echo $landid; ?>">Pay Now</a></td>
      </tr>
<?php 
}
}
