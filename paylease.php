...
<title>Pay Leased Land </title>
</head>

<body>
<form  method="post">
       <table  border="1" align="center">
        <tr><td colspan="2"  align="center"><h3>Pay Leased Land</h3></tr>
...
<tr>
    ...
    <td>PAID BY (FULL NAME)</td><td><input name="full_name" type="text" /></td></tr><tr>
    <td>PAYER CONTACT (ADDRESS, PHONE NUMBER)</td><td><input name="contact" type="text" /></td>
      </tr>
