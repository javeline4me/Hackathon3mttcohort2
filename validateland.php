...
<title>Validate Land Ownership</title>
</head>

<body>
<form  method="post">
       <table  border="1" align="center">
        <tr><td colspan="2"><h3>Land owner validation</h3></tr>
...
<tr>
    ...
    <td>BlockChain</td><td><?php echo $shaHash; ?></td>
      </tr>
...
if(isset($_POST["submit"])){
   // $shaHash;
 //    SELECT * FROM landregistration WHERE landid='$id'
 //$landid="";
 $leaseid="";
 $cropid="";
 $pdtid="";
...
// echo $sql;
 ...
 $sql = "UPDATE landregistration SET `blockchain`='$shaHash' WHERE landid='$id'";

 //echo $sql;
 if(mysqli_query($conn, $sql)){
    $sql1 = "INSERT INTO blockchainregister (`landid`, `landblockchain`,`leaseid`, `cropid`, `pdtid`, `status`)VALUES ('$landid','$shaHash', '$leaseid', '$cropid', '$pdtid', '$status')";
    mysqli_query($conn, $sql1);
    echo "Land Owner Validated successfully";
} else {
