...
<title>View all registered land</title>
</head>

<body>
<table  border="1">
    <tr><td colspan="15" align="center"> <h3>VALIDATE LAND OWNERSHIP </h3></td></tr>
<tr>
...
$landid =$raw["landid"];
    ...
    <td>
<a href="validateland.php?id=<?php echo $landid; ?>">Validate</a></td>
      </tr>
<?php 
}
}
